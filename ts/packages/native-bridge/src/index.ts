...
export function createUnavailableNativeBridge(): NativeBridgeModule {
  return {
    ...
    deleteModelEndpoint: unavailable("delete_model_endpoint"),
    ...
    deleteModelConfiguration: unavailable("delete_model_configuration"),
    ...
    requestTelegramOperatorConsult: unavailable("initialize_engine"),
    prepareTelegramOperatorConsultDelivery: unavailable("initialize_engine"),
    settleTelegramOperatorConsult: unavailable("initialize_engine"),
    listTelegramOperatorConsults: unavailable("initialize_engine"),
