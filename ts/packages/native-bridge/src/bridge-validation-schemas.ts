  ...
  Type.Object(
    {
      ...
      profileFingerprint: Type.Optional(Type.String()),
      providerFingerprint: Type.Optional(Type.String()),
      status: Type.Union([
        Type.Literal("unused"),
        Type.Literal("valid"),
      ...
      invalidatedAt: Type.Optional(Type.String()),
...
export const rawContextCompactionArtifactSchema = Type.Object(
  {
    ...
    strategy_revision: Type.Optional(nullableString),
    logical_turn_id: Type.Optional(nullableString),
    execution_epoch_id: Type.Optional(nullableString),
    source_projection_fingerprint: Type.Optional(nullableString),
    trigger: Type.Optional(nullableString),
    before_tokens: Type.Optional(nullableNumber),
    after_tokens: Type.Optional(nullableNumber),
    preserved_item_count: Type.Optional(nullableNumber),
    excised_item_count: Type.Optional(nullableNumber),
    intent_key: Type.Optional(nullableString),
    terminal_status: Type.Optional(nullableString),
    provider_chain_action: Type.Optional(nullableString),
