...
export const API_CAPABILITIES = [
  ...
  readCapability(
    ...
    "GET",
    "/v1/admin/diagnostics/review-submission-recovery",
    "Read bounded pending, retry/backoff, terminal reconciliation, and suppressed-dispatch diagnostics.",
    "admin",
    ["service", "diagnostics", "governance"],
  ),
  readCapability(
    ...
    "Read browser-safe Den review authority configuration and health without exposing credentials.",
    "admin",
  ...
  writeCapability(
    ...
    "PATCH",
    "/v1/admin/review-operator/config",
    "Atomically update non-secret Den review authority configuration and reload it.",
    "admin",
  ...
  readCapability(
    ...
    "Read a bounded projection of Den review state composed with Crew managed-delivery state.",
    "admin",
    ["service", "diagnostics", "governance"],
  ),
  readCapability(
  ...
  writeCapability(
    ...
    "Send exactly review task_id to @reviewer through generic receipt-backed Crew messaging.",
    "admin",
    ["service", "delegation", "governance"],
  ),
  writeCapability(
  ...
  writeCapability(
    "review.submissions.reconcile",
    "POST",
    "/v1/admin/review-submissions/{submission_id}/reconcile",
    "Idempotently reconcile one submission against authoritative Den and its durable delivery state.",
    "admin",
    ["service", "governance", "diagnostics"],
  ),
  readCapability(
