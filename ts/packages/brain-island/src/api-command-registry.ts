...
export const API_CAPABILITIES = [
  ...
  readCapability(
    ...
    "GET",
    "/v1/coordination/messages",
    "Inspect and filter durable production routed-message provenance, exact model input, queue, wake, expiry, and reply state.",
    "admin",
  ...
  readCapability(
    ...
    "GET",
    "/v1/debug/coordination/messages",
    "Inspect and filter durable debug routed-message provenance, exact model input, queue, wake, expiry, and reply state.",
    "admin",
    ["session", "diagnostics"],
  ),
  writeCapability(
