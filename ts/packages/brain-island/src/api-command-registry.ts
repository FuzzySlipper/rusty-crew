...
export const API_CAPABILITIES = [
  ...
  readCapability(
    ...
    "Read profile registry, file fallback, and asset drift diagnostics.",
    "admin",
    ["diagnostics", "profile"],
  ),
  readCapability(
    ...
    "List DB-backed profile registry records plus file-backed fallback projections.",
    "admin",
    ["diagnostics", "profile"],
  ),
  readCapability(
    ...
    "Read one profile registry record or file-backed fallback projection.",
    "admin",
    ["diagnostics", "profile"],
  ),
  readCapability(
