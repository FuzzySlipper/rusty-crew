...
export const defaultToolExecutableBindings = [
  ...
  },
  {
    ...
    implementationModule: "./coordination-tools.js#replyAgentMessageTool",
    inventoryTest: "smoke:coordination-tools",
  },
  {
    name: "agent_round",
  ...
  {
    name: "inspect_roleplay_proposals",
    implementationModule:
      "./roleplay-mechanic-tools.js#inspectRoleplayProposalsTool",
    inventoryTest: "smoke:roleplay-mechanic-diagnostics",
  },
  {
    name: "propose_roleplay_change",
    implementationModule:
      "./roleplay-mechanic-tools.js#proposeRoleplayChangeTool",
    inventoryTest: "smoke:roleplay-mechanic-diagnostics",
  },
  {
    name: "record_roleplay_diagnostic",
    implementationModule:
      "./roleplay-mechanic-tools.js#recordRoleplayDiagnosticTool",
    inventoryTest: "smoke:roleplay-mechanic-diagnostics",
  },
  {
