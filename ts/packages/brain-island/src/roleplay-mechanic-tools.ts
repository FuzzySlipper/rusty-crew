    ...
    execute: async (_callId, params) => {
      ...
      try {
        ...
        const diagnostic = await input.bridge.createRoleplayMechanicDiagnostic({
          ...
          modelConfigId: input.profile.modelConfig.modelConfigId,
          modelConfigRevision: input.profile.modelConfig.modelConfigRevision,
          endpointId: input.profile.modelConfig.endpointId,
          endpointRevision: input.profile.modelConfig.endpointRevision,
          credentialId: input.profile.modelConfig.credentialId,
          credentialRevision: input.profile.modelConfig.credentialRevision,
