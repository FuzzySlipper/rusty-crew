...
export function providerStateFingerprintMaterial(
  ...
  const compatibility: ProviderStateFingerprintMaterial["compatibility"] = {
    ...
    providerEndpoint: {
      endpointId: profile.modelConfig.endpointId,
      baseUrl: profile.modelConfig.baseUrl,
      credentialId: profile.modelConfig.credentialId,
      credentialRevision: profile.modelConfig.credentialRevision,
      credentialKind: profile.modelConfig.credentialKind,
      authScheme: profile.modelConfig.authScheme,
      promptCacheTransport: profile.modelConfig.promptCacheTransport,
    },
    model: {
      modelConfigId: profile.modelConfig.modelConfigId,
      modelName: profile.modelConfig.modelName,
      contextWindowTokens: profile.modelConfig.contextWindowTokens,
