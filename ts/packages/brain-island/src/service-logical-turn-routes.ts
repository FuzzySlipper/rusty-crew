...
function diagnosticPayload(
  ...
  return {
    ...
    model_config_id: diagnostic.binding.modelConfigId,
    model_config_revision: diagnostic.binding.modelConfigRevision,
    endpoint_id: diagnostic.binding.endpointId,
    endpoint_revision: diagnostic.binding.endpointRevision,
    credential_id: diagnostic.binding.credentialId,
    credential_revision: diagnostic.binding.credentialRevision,
    provider_alias: diagnostic.binding.providerAlias,
    provider_revision: diagnostic.binding.providerRevision,
