  ...
  bodyState: insertJson({
    ...
    recent_events: [
      ...
      { type: "agent_message_routed" },
      {
        ...
        receipt: {
          request: {
            deliveryId: "bridge-delivery",
            idempotencyKey: "bridge-delivery",
            messageId: "bridge-message",
            fromAgentId: "planner",
            requestedAddress: "bridge-agent",
            toAgentId: "bridge-agent",
            toSessionId: sessionId,
            inputKind: "routed_agent_message",
            body: "validated delivery",
            requireWake: true,
      ...
      },
      {
        ...
        round: {
          roundId: "bridge-round",
          idempotencyKey: "bridge-round",
          senderAgentId: "planner",
          recipientAgentId: "bridge-agent",
          recipientSessionId: sessionId,
          messageId: "bridge-round-message",
          correlationId: "bridge-round",
          status: "pending",
          createdAt: "2026-06-19T00:00:00Z",
          expiresAt: "2026-06-19T00:05:00Z",
          revision: 1,
