...
use rusty_crew_core_protocol::{
    ...
    ExternalAgentBindingMetadataWrite, ExternalBindingId, ExternalBindingPurpose,
    ExternalBindingStatus, ExternalCollaborationMode, ExternalControlId, ExternalControlKind,
    ExternalControlReceipt, ExternalControlRequest, ExternalControlStatus,
...
pub(crate) fn hash_json(value: &serde_json::Value, action: &str) -> CoreResult<String> {
