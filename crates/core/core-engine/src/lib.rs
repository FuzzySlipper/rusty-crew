...
use rusty_crew_core_protocol::{
    ...
    ModelConfigurationQuery, ModelConfigurationRecord, ModelConfigurationWrite, ModelEndpointQuery,
    ...
    ModelProviderRecord, ModelProviderRefreshImpact, ModelProviderRefreshImpactRequest,
