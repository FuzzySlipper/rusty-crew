...
use rusty_crew_core_protocol::{
    ...
    AttachmentLinkId, BrainEvent, ChatCompletionsReasoningHistory, ChatCompletionsThinkingMode,
    ChatCompletionsWireDialect, CompletionPacket, ContextCompactionArtifact,
