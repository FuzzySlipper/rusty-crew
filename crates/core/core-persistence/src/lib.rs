...
use rusty_crew_core_protocol::{
    ...
    LogicalTurnAdmission, LogicalTurnCancelRequest, LogicalTurnCancellationReceipt,
    LogicalTurnCheckpoint, LogicalTurnClaimRequest, LogicalTurnContinuationClaim,
