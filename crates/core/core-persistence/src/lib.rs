...
use rusty_crew_core_protocol::{
    ...
    ChatCompletionsPromptCachingPolicy, ChatCompletionsReasoningHistory,
    ChatCompletionsThinkingMode, ChatCompletionsWireDialect, CompletionPacket,
    ...
    ExternalTurnPage, ExternalTurnPageQuery, ExternalTurnRequestId, FanOutFailurePolicy,
    FanOutGroupStatus, InstallDiplomatBindingQuery, InstallDiplomatBindingRecord,
    InstallDiplomatBindingStatus, IsoTimestamp, LogicalTurnAdmission, LogicalTurnAttentionReceipt,
    ...
    MessageSlotId, MessageVariantId, ModelConfigurationDelete, ModelConfigurationQuery,
    ModelConfigurationRecord, ModelConfigurationWrite, ModelEndpointAuthScheme,
    ModelEndpointBackfillReport, ModelEndpointDelete, ModelEndpointJoinedProjectionEquality,
    ModelEndpointLegacyAliasMapping, ModelEndpointQuery, ModelEndpointRecord,
    ModelEndpointRepresentabilityError, ModelEndpointWireDialect, ModelEndpointWrite,
    ...
    ProfileRegistryWrite, ProjectId, PromptCacheTransport, ProviderStateAbsenceReason,
    ProviderStateCompatibilityAction, ProviderStateCompatibilityPlan,
    ProviderStateCompatibilitySnapshot, ResourceLimits, ResponsesProviderDialect,
    ReviewSubmissionPhase, ReviewSubmissionRecord, RunId, RuntimeActivityId, RuntimeActivityKind,
    RuntimeActivityRecord, RuntimeActivityStatus, ServiceCredentialDelete, ServiceCredentialQuery,
