...
use rusty_crew_core_protocol::{
    ...
    MessageSlotId, MessageVariantId, ModelConfigurationQuery, ModelConfigurationRecord,
    ...
    ProfileRegistryUpdate, ProfileRegistryWrite, ProjectId, PromptCacheTransport,
