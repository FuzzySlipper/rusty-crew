...
use rusty_crew_core_protocol::{
    ...
    ModelProviderSecretEnvelope, ModelProviderStatus, ModelProviderWrite, ParentConsumptionPolicy,
    ProfileId, ProfilePurgeReport, ProfilePurgeTableCount, ProfileRegistryLifecycleStatus,
