...
use crate::{
    ...
    MessageVariantStatus, MessageVariantWrite, ModelConfigurationDelete, ModelConfigurationQuery,
    ...
    PromptCacheTransport, ProviderStateAbsenceReason, ProviderStateCompatibilityAction,
    ProviderStateCompatibilityPlan, ProviderStateCompatibilitySnapshot,
    ...
    ReorderChatMessageVariantsRequest, ResponsesProviderDialect, ReviewSubmissionRecord,
            ...
            &format!(
                "SELECT record_json
                 ...
                 WHERE ($1::TEXT IS NULL OR session_id = $1)
                   ...
                   AND ($5::TEXT IS NULL OR record_json::jsonb->>'terminal_status' = $5)
