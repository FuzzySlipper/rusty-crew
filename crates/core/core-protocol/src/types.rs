...
string_id!(AttachmentLinkId);
string_id!(DataBankScopeId);
...
pub struct ProfileRegistryRecord {
    ...
    pub prompt_soul_markdown: Option<String>,
    pub prompt_memory_markdown: Option<String>,
...
impl CoreEventKind {
    pub const fn of(event: &CoreEvent) -> Self {
        match event {
            ...
            CoreEvent::SessionExecutionObserved { .. } => Self::SessionExecutionObserved,
...
pub enum CoreEvent {
    ...
    SessionExecutionObserved {
        execution: crate::SessionExecutionState,
    },
    LogicalTurnLifecycleObserved {
