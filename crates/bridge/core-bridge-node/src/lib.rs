...
use rusty_crew_core_protocol::{
    ...
    ManualContextCompactionRequest, ManualContextCompactionResponse, MemoryGovernanceDecisionInput,
    ...
    ProfileRegistryUpdate, ProfileRegistryWrite, ReviewSubmissionQuery, ReviewSubmissionRequest,
